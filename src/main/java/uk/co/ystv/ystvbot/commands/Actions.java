...
public class Actions extends Command {
	...
	private String[] actions = new String[] { "kill", "slap", "cuddle", "random" };
	private String[] descriptions = new String[] { "!kill <user> - Might be a bit too far", "!slaps <user> - Settle your differences the old fashioned way", "!cuddle <user> - Spread the YSTV love", "!random <user> - Pretend to be helen" };
